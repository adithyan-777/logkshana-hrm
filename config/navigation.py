...
COMMAND_PALETTE: list[dict[str, str]] = [
    {"title": "Dashboard", "subtitle": "Today’s attendance pulse", "url_name": "dashboard", "group": "Overview", "icon": "bx-grid"},
    {"title": "Employees", "subtitle": "Company directory", "url_name": "employee_list", "group": "People", "icon": "bx-user"},
    {"title": "Add employee", "subtitle": "Create a staff record", "url_name": "employee_add", "group": "People", "icon": "bx-user-plus"},
    {"title": "Punches", "subtitle": "Raw check-in and check-out", "url_name": "attendance_transaction_list", "group": "Attendance", "icon": "bx-walk"},
    {"title": "Record punch", "subtitle": "Log a check-in or check-out", "url_name": "attendance_transaction_add", "group": "Attendance", "icon": "bx-plus"},
    {"title": "Daily attendance", "subtitle": "Calculated day outcomes", "url_name": "daily_attendance_list", "group": "Attendance", "icon": "bx-calendar-check"},
    {"title": "Corrections", "subtitle": "Punch fixes awaiting review", "url_name": "attendance_correction_list", "group": "Attendance", "icon": "bx-edit"},
    {"title": "Attendance rules", "subtitle": "Grace periods and calculation", "url_name": "attendance_rule_list", "group": "Attendance", "icon": "bx-slider"},
    {"title": "Leave requests", "subtitle": "Time-off awaiting a decision", "url_name": "leave_request_list", "group": "Leave", "icon": "bx-calendar-minus"},
    {"title": "Add leave request", "subtitle": "Create a leave request", "url_name": "leave_request_add", "group": "Leave", "icon": "bx-plus"},
    {"title": "Leave types", "subtitle": "Paid, unpaid, and categories", "url_name": "leave_type_list", "group": "Leave", "icon": "bx-category"},
    {"title": "Leave policies", "subtitle": "Entitlement and accrual", "url_name": "leave_policy_list", "group": "Leave", "icon": "bx-shield"},
    {"title": "Holidays", "subtitle": "Company calendar", "url_name": "holiday_list", "group": "Leave", "icon": "bx-party"},
    {"title": "Timetables", "subtitle": "Check-in and check-out times", "url_name": "timetable_list", "group": "Schedule", "icon": "bx-clock-5"},
    {"title": "Shifts", "subtitle": "Named rotations", "url_name": "shift_list", "group": "Schedule", "icon": "bx-repeat"},
    {"title": "Assignments", "subtitle": "Who works which shift", "url_name": "assignment_list", "group": "Schedule", "icon": "bx-user-circle"},
    {"title": "Temporary schedule", "subtitle": "One-off overrides", "url_name": "temporary_list", "group": "Schedule", "icon": "bx-calendar-exclamation"},
    {"title": "Reports", "subtitle": "Analytics hub", "url_name": "report_hub", "group": "Reports", "icon": "bx-chart-bar-columns"},
    {"title": "Attendance summary", "subtitle": "Totals per employee", "url_name": "report_attendance_summary", "group": "Reports", "icon": "bx-bar-chart"},
    {"title": "Individual attendance", "subtitle": "Day-by-day for one person", "url_name": "report_individual_attendance", "group": "Reports", "icon": "bx-id-card"},
    {"title": "Department attendance", "subtitle": "Aggregated by department", "url_name": "report_department_attendance", "group": "Reports", "icon": "bx-buildings"},
    {"title": "Exceptions", "subtitle": "Late, absent, missing punch", "url_name": "report_exceptions", "group": "Reports", "icon": "bx-error-circle"},
    {"title": "Punch log", "subtitle": "Raw punch stream", "url_name": "report_punch_log", "group": "Reports", "icon": "bx-list-ul"},
    {"title": "Overtime", "subtitle": "Overtime minutes and status", "url_name": "report_overtime", "group": "Reports", "icon": "bx-time-five"},
    {"title": "Leave reports", "subtitle": "Balance and utilization", "url_name": "report_leave", "group": "Reports", "icon": "bx-calendar"},
    {"title": "Profile", "subtitle": "Account details", "url_name": "account_profile", "group": "Account", "icon": "bx-user"},
]
