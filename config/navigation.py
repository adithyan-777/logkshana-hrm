...
LIST_ACTIONS: dict[str, tuple[str, str]] = {
    ...
    "daily_attendance_list": ("Add correction", "daily_attendance_add"),
...
PAGE_HEADINGS: dict[str, str] = {
    ...
    "daily_attendance_add": "Add Correction",
...
PAGE_SUBTITLES: dict[str, str] = {
    ...
    "attendance_transaction_list": "Punches and daily outcomes.",
    "daily_attendance_list": "Punches and daily outcomes.",
    "attendance_transaction_add": "Record a check-in or check-out.",
    "daily_attendance_add": "Add a correction row.",
    ...
    "timetable_list": "Timetables, breaks, and schedules.",
