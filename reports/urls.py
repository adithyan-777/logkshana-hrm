...
urlpatterns = [
    ...
    path(
        "attendance/", views.attendance_summary_view, name="report_attendance_summary"
    ),
    path(
        "individual/",
        views.individual_attendance_view,
        name="report_individual_attendance",
    ),
    path(
        "department/",
        views.department_attendance_view,
        name="report_department_attendance",
    ),
