...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                "constraints": [
                    models.UniqueConstraint(fields=("code",), name="unique_shift_code")
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("normal", "Normal"), ("flexible", "Flexible")],
                        default="normal",
                        max_length=20,
                    ),
                ),
            ...
            options={
                "constraints": [
                    models.UniqueConstraint(
                        fields=("code",), name="unique_timetable_code"
                    )
                ],
            },
        ),
            ...
            options={
                "indexes": [
                    models.Index(
                        ...
                        name="schedule_sc_employe_a34acf_idx",
                    ),
                    models.Index(
                        fields=["start_date", "end_date"],
                        name="schedule_sc_start_d_1e0822_idx",
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="schedule_te_employe_764aad_idx",
                    )
                ],
                "constraints": [
                    models.UniqueConstraint(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("shift", "day_number"), name="unique_shift_day"
                    )
                ],
            },
        ),
